    ...
    <div className="p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-sm text-muted-foreground mb-6">
          Connect AI assistants like Claude, Cursor, or Windsurf to your Webwow project.
        ...
        >
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Create a unique MCP URL for connecting an AI assistant to your Webwow project.
              </DialogDescription>
            </DialogHeader>
            <div className="py-4">
          ...
          <DialogContent>
            ...
            <div className="py-4">
              ...
              <p className="text-xs text-muted-foreground mt-3">
                Keep this URL private. Anyone with this URL can access your Webwow project through MCP.
              </p>
            </div>
            <DialogFooter>
              <Button
