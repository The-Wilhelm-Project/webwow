...
const ignoresConfig = defineConfig([
  {
    ...
    ignores: [
      '.next/', 'node_modules/', 'public/', '.vscode/', 'out/', 'build/',
      // Webwow: dev tooling, sample import data, runtime uploads and docs are not lint targets
      'tools/', 'import/', 'uploads/', 'docs/',
      // generated by Next (double-quoted triple-slash references)
      'next-env.d.ts',
    ],
  },
]);
